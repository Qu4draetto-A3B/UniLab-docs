...
\begin{figure}[h]
	...
	\includegraphics[width=0.8\linewidth]{img/QuickDBD-clima}
\end{figure}
...
\begin{figure}[h]
	...
	\label{fig:severcm}
	\includegraphics[width=0.9\linewidth]{drawio/serverCM}
\end{figure}
\pagebreak
...
\begin{figure}[h]
	...
	\label{fig:commonscm}
	\includegraphics[width=0.8\linewidth]{drawio/CM}
\end{figure}
\pagebreak
Come si può notare dal diagramma, comprende:
\begin{itemize}
